...
router.get('/all', async (req, res) => {
    let query = "SELECT * FROM rarepuppersdbschema_dev.cards FULL OUTER JOIN rarepuppersdbschema_dev.dogs ON rarepuppersdbschema_dev.cards.dog_id=rarepuppersdbschema_dogs._id";
    let order = " ORDER BY ";
    let dir = "";
