...
router.post('/mint', async (req, res) => {
    ...
    const response = db.query(`INSERT INTO rarepuppersdbschema_dev.cards VALUES (DEFAULT, $1, $2, $3, $4, $5, $6, DEFAULT, DEFAULT)`, [owner_id, dog_id, dog_owner_id, card_name, tier, attributes]);
    res.send(response);
});
